...
public class Cost implements Serializable {
    ...
    public String getCost_unit_name() {
        return cost_unit_name;
    }

    public void setCost_unit_name(String cost_unit_name) {
        this.cost_unit_name = cost_unit_name;
    }
}
