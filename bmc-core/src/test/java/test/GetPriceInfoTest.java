...
//        ins.setChangeCode("REMOVE");
//        ins.setInstanceId("0662d56f-572d-4d85-9947-dbe2cbdb58b3");
//        ins.setTenantId("CITIC");
//        ins.setTradeSeq("aaaaaaa");
//        iOrderChangeSV.orderChange(ins);
    }
    @Test
    public void test(){
